...
reward_plot1, optact_plot1, opt1 = tenArm.eGreedySA()
std1 = np.std(reward_plot1)
reward_plot2, optact_plot2, opt2 = tenArm.eGreedySA(epsilon = 0.01)
std2 = np.std(reward_plot2)
reward_plot3, optact_plot3, opt3 = tenArm.eGreedySA(epsilon = 0)
